<?php
foreach ($data as $blog_item): ?>

    <div class="col-md-4 col-sm-6">
        <a href="#"><img class="img-responsive" src="<?php print_r($blog_item["image"]) ?>" alt=""></a>
        <div class="site-blog-text">
            <h3><a href="#"><?php print_r($blog_item["title"]) ?></a></h3>
            <span class="site-blog-post"><?php echo date("d.m.Y в H:i", strtotime($blog_item["date"])) ?></span>
            <span class="site-blog-comment">
                <a href=""><?php print_r($blog_item["views"]) ?><i class="fas fa-eye"></i></a></span>
